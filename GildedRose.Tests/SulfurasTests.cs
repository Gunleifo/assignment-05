...
public class SulfurasTEsts
{
    ...
    [Theory]
    [InlineData("Sulfuras, Hand of Ragnaros", -45, 1, -45)]
    [InlineData("Sulfuras, Hand of Ragnaros", -5, 5, -5)]
    [InlineData("Sulfuras, Hand of Ragnaros", 0, 10, 0)]
    [InlineData("Sulfuras, Hand of Ragnaros", 1, 20, 1)]
    [InlineData("Sulfuras, Hand of Ragnaros", 10, 25, 10)]
    [InlineData("Sulfuras, Hand of Ragnaros", 15, 40, 15)]
    public void Given_Sulfuras_SellIn_Never_Changes_When_Updating(string item, int sellIn, int quality, int expected)
    {
        // Arrange
        Program program = new Program();
